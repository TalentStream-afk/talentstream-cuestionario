...
# Control de estado de envío para limpiar la pantalla al finalizar
...
if st.session_state.evaluacion_enviada:
    ...
    if not cedula_url:
        ...
        if not res.data:
            ...
            # Inicializamos variables para guardar la selección exacta
            ...
            # Botón de Procesamiento Completo
            if st.button("📤 Finalizar y Enviar Evaluación", type="primary", use_container_width=True):
                # Validamos que absolutamente todas las preguntas tengan respuesta
                if not all([ans_1, ans_2, ans_3, ans_4]):
                    ...
                    # Estructura limpia para calcular los puntos reales recopilados
                    ...
                    # Identificar la tendencia conductual principal
                    ...
                    # Envío masivo y simultáneo de los 5 campos a Supabase
                    ...
                    # Activamos bandera de éxito y reiniciamos
